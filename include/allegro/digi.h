...
typedef struct AL_SAMPLE                  /* a sample */
{
   int bits;                           /* 8 or 16 */
...
typedef struct DIGI_DRIVER             /* driver for playing digital sfx */
{
   ...
   AL_METHOD(void, init_voice, (int voice, AL_CONST AL_SAMPLE *sample));
...
AL_FUNC(AL_SAMPLE *, load_sample, (AL_CONST char *filename));
AL_FUNC(AL_SAMPLE *, load_wav, (AL_CONST char *filename));
AL_FUNC(AL_SAMPLE *, load_wav_pf, (struct PACKFILE *f));
AL_FUNC(AL_SAMPLE *, load_voc, (AL_CONST char *filename));
AL_FUNC(AL_SAMPLE *, load_voc_pf, (struct PACKFILE *f));
AL_FUNC(int, save_sample, (AL_CONST char *filename, AL_SAMPLE *spl));
AL_FUNC(AL_SAMPLE *, create_sample, (int bits, int stereo, int freq, int len));
AL_FUNC(void, destroy_sample, (AL_SAMPLE *spl));

AL_FUNC(int, play_sample, (AL_CONST AL_SAMPLE *spl, int vol, int pan, int freq, int loop));
AL_FUNC(void, stop_sample, (AL_CONST AL_SAMPLE *spl));
AL_FUNC(void, adjust_sample, (AL_CONST AL_SAMPLE *spl, int vol, int pan, int freq, int loop));

AL_FUNC(int, allocate_voice, (AL_CONST AL_SAMPLE *spl));
AL_FUNC(void, deallocate_voice, (int voice));
AL_FUNC(void, reallocate_voice, (int voice, AL_CONST AL_SAMPLE *spl));
...
AL_FUNC(AL_SAMPLE *, voice_check, (int voice));
...
AL_FUNC(void, lock_sample, (struct AL_SAMPLE *spl));

AL_FUNC(void, register_sample_file_type, (AL_CONST char *ext, AL_METHOD(struct AL_SAMPLE *, load, (AL_CONST char *filename)), AL_METHOD(int, save, (AL_CONST char *filename, struct AL_SAMPLE *spl))));
